...
![Supplied Dataset](Results/Supplied_Dataset/Data_Acquisition.PNG)

![Collected INR Dataset](Results/Collected_Dataset/Data_Acquisition.PNG)

## Results 

The results on Accuracy and Inference Time for supplied dataset:

![Supplied Dataset Accuracy](Results/Supplied_Dataset/Accuracy_InferenceTime_Supplied_Dataset.jpg)
...
![INR Banknotes Dataset Accuracy](Results/Collected_Dataset/Accuracy_Curve_INR_Currency_Model.jpg)
...
![Prediction on INR Banknotes Test Dataset](Results/Collected_Dataset/Prediction_Results_INR_Currency_Model.jpg)
